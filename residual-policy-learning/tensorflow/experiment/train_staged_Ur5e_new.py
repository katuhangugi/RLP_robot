...
@click.option('--env', type=str, default='Ur5PickAndPlace-v0', help='the name of the OpenAI Gym environment that you want to train on')
...
@click.option('--logdir', type=str, default="/home/joe/Work/RPL_local/logs/seed0/Ur5PickAndPlace-v0", help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
