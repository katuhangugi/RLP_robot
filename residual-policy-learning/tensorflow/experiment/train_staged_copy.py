...
@click.option('--logdir', type=str, default="/home/joe/Work/RPL_local/logs/seed0/UR5ePickAndPlace-v1", help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
