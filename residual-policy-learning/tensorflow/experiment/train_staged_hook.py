...
@click.option('--env', type=str, default='TwoFrameHookNoisy-v0', help='the name of the OpenAI Gym environment that you want to train on')
...
@click.option('--logdir', type=str, default="/home/joe/Work/RPL_local/logs/seed0/TwoFrameHookNoisy-v0", help='the path to where logs and policy pickles should go. If not specified, creates a folder in /tmp/')
...
@click.option('--config_path', type=str, default="/home/joe/Work/RPL_local/residual-policy-learning/tensorflow/experiment/configs/hook.json", help='path to json config file')
